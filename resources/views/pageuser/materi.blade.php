...
<head>
    ...
    <style>
        :root {
            --bg:#050a18;--card:#0d1526;--border:#1a2d55;
            --neon-b:#00c8ff;--neon-p:#a855f7;--neon-g:#00ff88;--neon-y:#ffd700;--neon-r:#ff4f7b;
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .orb2{width:300px;height:300px;background:var(--neon-p);bottom:-60px;right:-60px;animation-delay:4s;}
        ...
        .page-header h1{font-family:'Orbitron',monospace;font-size:clamp(1.5rem,4vw,2.5rem);font-weight:900;background:linear-gradient(135deg,var(--neon-b),var(--neon-p));-webkit-background-clip:text;-webkit-text-fill-color:transparent;margin-bottom:8px;}
        .page-header p{color:var(--muted);font-size:1em;}
        ...
        .books-grid{display:flex;flex-wrap:wrap;justify-content:center;gap:24px;}
        ...
        .book-card::after{content:'';position:absolute;bottom:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--neon-b),var(--neon-p));opacity:0;transition:opacity .3s;}
        .book-card:hover{transform:translateY(-10px);box-shadow:0 0 30px rgba(0,200,255,0.2);border-color:var(--neon-b);}
        .book-card:hover::after{opacity:1;}

        .book-card .book-icon{font-size:2.5em;margin-bottom:14px;display:block;}
        .book-card .book-title{font-family:'Orbitron',monospace;font-size:0.75em;font-weight:700;letter-spacing:1px;line-height:1.4;background:linear-gradient(135deg,var(--neon-b),var(--neon-p));-webkit-background-clip:text;-webkit-text-fill-color:transparent;}
        .book-card .book-sub{margin-top:8px;font-size:0.78em;color:var(--muted);background:rgba(0,200,255,0.08);border:1px solid rgba(0,200,255,0.15);padding:3px 10px;border-radius:20px;display:inline-block;}
...
<div class="container">
    ...
    <div class="books-grid">
        ...
        @empty
        <div class="empty-state"><i class="fas fa-satellite"></i><p>Belum ada mata pelajaran tersedia.</p></div>
        @endforelse
    </div>
</div>
</body>
