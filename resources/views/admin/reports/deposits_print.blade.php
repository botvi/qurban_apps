...
<head>
    ...
    <title>Cetak Laporan Setoran Tabungan Qurban</title>
    <style>
        body {
...
<body onload="window.print()">
    ...
    <div class="title">
        Laporan Setoran Tabungan Qurban
    ...
    <table class="report-table">
        ...
        <tbody>
            @foreach($deposits as $idx => $deposit)
            <tr>
                <td>{{ $idx + 1 }}</td>
                <td>#SET-{{ str_pad($deposit->id, 5, '0', STR_PAD_LEFT) }}</td>
        ...
        <tfoot>
            <tr style="background-color: #f2f2f2;">
                <th colspan="5" style="text-align: right; font-weight: bold;">TOTAL SETORAN:</th>
