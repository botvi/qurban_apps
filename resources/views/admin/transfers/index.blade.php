                        ...
                        <table class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong>{{ $sub->participant->nama ?? '-' }}</strong>
                                        @if($sub->participant)
                                            @php
                                                $activeTarget = $sub->participant->activeTarget();
                                            @endphp
                                            @if($activeTarget)
                                                @php
                                                    $pct = $activeTarget->target_dana > 0 ? ($sub->participant->balance / $activeTarget->target_dana) * 100 : 0;
                                                ...
                                                <div style="font-size: 0.78em; margin-top: 4px; color: #4b5563;">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <span style="font-weight: 700; color: #047857;">{{ round($pct, 1) }}% (Rp {{ number_format($sub->participant->balance, 0, ',', '.') }})</span>
                                                    </div>
                                                </div>
                                            @else
