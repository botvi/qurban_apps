...
<head>
    ...
    <title>Bukti Setoran Tabungan Qurban #{{ $deposit->id }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="title">Bukti Setoran Tabungan Qurban</div>

    <table class="details-table">
        <tr>
            <td style="width: 30%;">No. Transaksi</td>
            <td style="width: 3%;">:</td>
            <td style="font-weight: bold;">#SET-{{ str_pad($deposit->id, 5, '0', STR_PAD_LEFT) }}</td>
        </tr>
        <tr>
            <td>Tanggal Transaksi</td>
            <td>:</td>
            <td>{{ date('d F Y', strtotime($deposit->tanggal)) }}</td>
        </tr>
        <tr>
            <td>NIK Peserta</td>
            <td>:</td>
            <td>{{ $deposit->participant->nik }}</td>
        </tr>
        <tr>
            <td>Nama Peserta</td>
            <td>:</td>
