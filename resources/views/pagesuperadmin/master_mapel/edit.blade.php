              ...
              <form action="{{ route('mapel.update', $mapel->id) }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select name="kelas" class="form-control" required>
                      <option value="VII" {{ $mapel->kelas == 'VII' ? 'selected' : '' }}>VII</option>
                      <option value="VIII" {{ $mapel->kelas == 'VIII' ? 'selected' : '' }}>VIII</option>
                      <option value="IX" {{ $mapel->kelas == 'IX' ? 'selected' : '' }}>IX</option>
                  </select>
                </div>
